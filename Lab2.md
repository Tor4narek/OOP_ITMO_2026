...
Цель репозитория — изолировать бизнес-логику от способа хранения данных и подготовить код к возможной замене хранилища (БД, файл и т.д.)
...
* **4 балла** — корректная работа репозитория и LINQ-отчетов,
...
* **3 балла** — ответы по темам лекций 2.
